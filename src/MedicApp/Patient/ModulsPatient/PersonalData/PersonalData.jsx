...
import $ from 'jquery';
import PersonalAppointment from './PersonalAppointment/PersonalAppointment';
    ...
    <div className='container-fluid overflow-x-hidden'>
      <div className='row'>
        <div className='col-12'>
          <h2 className='m-0 p-0 lh-sm fs-3- ff-monse-regular- fw-bold tx-dark-purple- white font_medium'>Registros especificos</h2>
        </div>
      </div>
