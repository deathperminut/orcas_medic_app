...
import MedicValidation from './MedicValidation/MedicValidation';
    ...
    <div className='container-fluid overflow-x-hidden'>
      <div className='row'>
        <div className='col-12'>
          <h2 className='m-0 p-0 lh-sm fs-3- ff-monse-regular- fw-bold tx-dark-purple- white font_medium'>Datos médico</h2>
        </div>
      </div>
      ...
      <div className='row g-4 mt-3'>
        ...
        <div className='col-12 col-sm-12 col-md-12 col-lg-12 col-xl-8 col-xxl-8 bg-gray'>
          <div id="card-view" className='card border-0 rounded-3 w-100 bs-2- bg-gray'>
            ...
            <Routes>
              <Route path="" element={ <Navigate to="Validation" /> }/>
              <Route path="Validation/*" element={<MedicValidation/>} />
            </Routes>
            </div>
          </div>
        </div>
